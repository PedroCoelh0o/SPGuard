...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema corporativo de gerenciamento de colaboradores de empresas contratadas." },
      { property: "og:title", content: "Gestão de Colaboradores" },
      { property: "og:description", content: "Sistema corporativo de gerenciamento de colaboradores de empresas contratadas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Gestão de Colaboradores" },
      { name: "twitter:description", content: "Sistema corporativo de gerenciamento de colaboradores de empresas contratadas." },
